$(document).ready(function () {
    ...
    $('.signUp').on('click', function () {
        $(this).width('90%').css({ 'cursor': 'default', 'background': 'url("./imgs/signUpBg.jpg")', 'backgroundSize': 'cover' });
    ...
    $('.signIn').on('click', function () {
        ...
        $(this).width('90%').css({ 'cursor': 'default', 'background': 'url("./imgs/signInBg.jpg")', 'backgroundSize': 'cover' });
    ...
    $('#signUpPassword').on('blur', function () {
        if ($(this).val().match(passwordValidation) && $(this).val().length >= 6 && $(this).val().length <= 12) {
            $(this).css('borderBottom', '2px solid #99043D');
